...
CREATE TABLE `aplicador` (
  `cpf_aplicador` int NOT NULL,
  `nome_aplicador` varchar(60) DEFAULT NULL,
  `senha_aplicador` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`cpf_aplicador`)
...
-- Dump completed on 2023-12-08 11:44:26
